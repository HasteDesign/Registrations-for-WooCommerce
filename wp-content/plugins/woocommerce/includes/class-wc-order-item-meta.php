			...
			foreach ( $formatted_meta as $meta ) {
				if ( $flat ) {
					...
					$meta_list[] = '
						...
						<dd class="variation-' . sanitize_html_class( sanitize_text_field( $meta['key'] ) ) . '">' . wp_kses_post( wpautop( make_clickable( apply_filters( 'woocommerce_variation_option_name', $meta['value'] ) ) ) ) . '</dd>
					';
				}
			}
