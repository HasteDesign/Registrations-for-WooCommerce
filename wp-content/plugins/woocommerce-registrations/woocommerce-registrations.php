...
class WC_Registrations {
  ...
  // * @since 1.0
  // */
  // ublic static function enqueue_styles_scripts() {
  ...
  // * @since 0.1
  // */
  // ublic static function add_registrations_to_select( $product_types ){
  //
  ...
  // * @since 0.1
  // */
  // ublic static function registrations_general_fields() {
  // global $post;
  //
  ...
  // * @since 0.1
  // */
  // ublic static function variable_registration_pricing_fields( $loop, $variation_data, $variation ) {
  ...
  // * @since 0.1
  // */
  // ublic static function save_registrations_meta( $post_id ) {
  //
  ...
  //
  //
  // ublic static function registration_dates_tab( $tabs ) {
  // // Adds the new tab
  //
  // $tabs['dates'] = array(
  // 	'title' 	=> __( 'Dates', 'woocommerce-registrations' ),
  // 	'priority' 	=> 50,
  // 	'callback' 	=> __CLASS__ . '::dates_tab_content',
  ...
  //
  //
  // ublic static function dates_tab_content() {
  //
  // // The new tab content
