...
class WC_Registrations_Orders {
  ...
  public function init() {
    ...
    add_action( 'manage_shop_order_posts_custom_column', __CLASS__ . '::add_course_details_column_content' );
  }
  ...
  public static function add_registration_details_column( $columns ) {
      ...
      $new_columns['course_booked'] = 'Course(s) booked';
   ...
   * @since 1.0.7
   */
  public static function add_course_details_column_content ( $column ) {
