...
<div class="show_if_registration">
    ...
    <p class="form-row form-row-last show_if_range_date">
        ...
        <label><input type="checkbox" name="_week_days[<?php echo $loop; ?>][]" <?php if( in_array( 'friday', $week_days ) ) { echo 'checked'; } ?>    value="friday" /><?php _e( 'Friday', 'woocommerce-registrations' ); ?></label>
        <label><input type="checkbox" name="_week_days[<?php echo $loop; ?>][]" <?php if( in_array( 'saturday', $week_days ) ) { echo 'checked'; } ?>  value="saturday" /><?php _e( 'Saturday', 'woocommerce-registrations' ); ?></label>
    </p>
</div>
